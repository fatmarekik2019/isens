var Facturer = function () {
    ...
    var handleTable = function () {
        ...
        var table = $('#resume_facturer_table');
        var oTable = table.DataTable({
			...
			"ajax": {
				"url": "/Admin/refonte/assets/admin/pages/getResume.php?table=facturer", // ajax source
				"type": "POST",
				"data": function(data) {
        ...
        var tableWrapper = $("#resume_facturer_table_wrapper");
