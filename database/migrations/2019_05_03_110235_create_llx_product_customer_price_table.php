...
class CreateLlxProductCustomerPriceTable extends Migration {
	...
	public function up()
	{
		Schema::create('llx_product_customer_price', function(Blueprint $table)
		{
			$table->integer('rowid');
	...
	{
		Schema::drop('llx_product_customer_price');
	}
