	...
	$.ajax({
		...
		success: function(response) {
			...
			$('#LoadingGraphic').fadeOut('fast', function() {
				...
				result = '';
				c = '';
				if (response === '<h3>Votre email a été envoyé.</h3>Nous y répondrons au plus vite.<br />Merci <br />') { 
					result = 'Your message has been sent. Thank you!';	// The thank you message shown after sending
					c = '<h3>Votre email a été envoyé.</h3>Nous y répondrons au plus vite.<br />Merci <br />';
				} else {
					result = response;
					c = 'error';
				}
