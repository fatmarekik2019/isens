...
include_once '../../../phpmailer/PHPMailerAutoload.php';
	...
	if ((isset($_POST["dest"]) || isset($_POST["newdest"])) && isset($_POST["subject"]) && isset($_POST["message"]) && isset($_POST["facnumber"])) {
		...
		$mail->addStringAttachment(file_get_contents('ftp://u35397007:neiljad1@dlb.shamsconseils.com/dlb/documents/facture/'.$_POST["facnumber"].'/'.$_POST["facnumber"].'.pdf'), $_POST["facnumber"].'.pdf');
