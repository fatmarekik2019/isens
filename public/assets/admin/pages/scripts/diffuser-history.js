var DiffuserHistory = function () {

    var handleTable = function () {
		
		$.fn.dataTable.moment( 'DD-MM-YYYY HH:mm:ss' );

        var table = $('#diffuser_history_table');
        var oTable = table.DataTable({
			...
			"ajax": {
				"url": "/Admin/refonte/assets/admin/pages/getResume.php?table=diff-history", // ajax source
				"type": "POST",
				"data": function(data) {
					data[0] = $('#phpVar').val();
					Metronic.blockUI({
						message: 'Chargement...',
						target: $("#diffuser_history_table_wrapper"),
						overlayColor: 'none',
						cenrerY: true,
						boxed: true
					});
				...
				"dataSrc": function(res) {
					Metronic.unblockUI($("#diffuser_history_table_wrapper"));
					return res.data;
				},
				"error": function() {
					Metronic.alert({
						...
						container: $("#diffuser_history_table_wrapper"),
						place: 'prepend',
						close: true,
						reset: true,
						focus: true
